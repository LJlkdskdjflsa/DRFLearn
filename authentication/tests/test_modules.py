...
class TestModel(APITestCase):
    ...
    def test_raises_error_when_no_username_is_supplied(self):
        self.assertRaises(ValueError,User.objects.create_user, username='', email='test@test.com', password='test_password')
    ...
    def test_raises_error_when_no_email_is_supplied(self):
        self.assertRaises(ValueError,User.objects.create_user, username='testuser', email='', password='test_password')
